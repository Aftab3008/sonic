          ...
          <CardContent className="pt-6 space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label>Name *</Label>
                <Input {...register("name", { required: true })} placeholder="Artist name" />
              </div>
              <div className="space-y-2">
                <Label>Slug *</Label>
                <Input {...register("slug", { required: true })} placeholder="artist-slug" />
              </div>
            </div>

            <div className="space-y-2">
              <Label>Bio</Label>
              <Textarea {...register("bio")} placeholder="Artist biography..." rows={4} />
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <Input {...register("socialLinks.instagram")} placeholder="@handle" />
                </div>
                <div className="space-y-2">
                  <Label className="text-xs text-muted-foreground">Twitter</Label>
                  <Input {...register("socialLinks.twitter")} placeholder="@handle" />
                </div>
                <div className="space-y-2">
