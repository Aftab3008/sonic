    ...
    <div className={cn("flex", "flex-col", "flex-1", "gap-4")}>
                    ...
                    >
                      {leafColumns.map((column) => (
                        <TableCell
                          ...
                          className={cn(column.id !== "actions" && "truncate")}
                        >
                          <div className="h-8" />
                        </TableCell>
                      ))}
                  ...
                  >
                    {row.getVisibleCells().map((cell) => {
                      return (
                        ...
                        >
                          <div className={cn(cell.column.id !== "actions" && "truncate")}>
                            {flexRender(
      ...
      {!isLoading && getRowModel().rows?.length > 0 && (
        <DataTablePagination
          ...
          currentPage={cursorPagination ? undefined : currentPage}
          pageCount={cursorPagination ? undefined : pageCount}
          setCurrentPage={cursorPagination ? undefined : setCurrentPage}
        />
      )}
    </div>
  );
